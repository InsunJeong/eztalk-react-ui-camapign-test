...
var reIsNative = RegExp("^" + funcToString3.call(hasOwnProperty7).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
//# sourceMappingURL=chunk-RG6I3GT6.js.map
