...
function useSnapshot(proxyObject, options) {
  ...
  const lastCallback = (0, import_react.useRef)();
  const notifyInSync = options == null ? void 0 : options.sync;
  const currSnapshot = (0, import_shim.useSyncExternalStore)((0, import_react.useCallback)((callback) => {
  ...
  }, [proxyObject, notifyInSync]), (0, import_react.useMemo)(() => {
    let prevSnapshot;
    return () => {
      const nextSnapshot = snapshot(proxyObject);
      try {
        if (prevSnapshot && lastAffected.current && !u(prevSnapshot, nextSnapshot, lastAffected.current, /* @__PURE__ */ new WeakMap())) {
          return prevSnapshot;
        }
      } catch (e) {
      }
  ...
  }, [proxyObject]), (0, import_react.useCallback)(() => snapshot(proxyObject), [proxyObject]));
  ...
  return a(currSnapshot, affected, proxyCache);
}
export {
  getVersion,
  proxy,
